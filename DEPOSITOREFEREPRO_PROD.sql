DELIMITER $$
CREATE DEFINER=`kubocoreapiliber`@`%` PROCEDURE `DEPOSITOREFEREPRO`(
					...
					IF(Par_InsertaTabla = Var_SiInserta) THEN
						...
						ELSE
							CALL CONTATESORERIAPRO(
								Entero_Cero,            Var_MonedaId,       Var_InstitucionID,	Var_CuentaBancaria,		Entero_Cero,
								Entero_Cero,            Entero_Cero,        Fecha_Valida,		Fecha_Valida,			Var_MontoMov,
								DescripcionCredito,     Var_ReferenciaMov,  CliCredito,			EmitePoliza,			Entero_Cero,
					...
					IF(Par_InsertaTabla = Var_SiInserta) THEN
						...
						ELSE
							...
							CALL CONTATESORERIAPRO(
								Entero_Cero,        	Var_MonedaId,           Var_InstitucionID,  	Var_CuentaBancaria, 	Entero_Cero,
								Entero_Cero,            Entero_Cero,            Fecha_Valida,			Fecha_Valida,           Var_MontoMov,
								DescripcionCuenta,      Var_ReferenciaMov,  	CliCuentaAhoID,         EmitePoliza,            Entero_Cero,
					...
					IF(Par_InsertaTabla = Var_SiInserta) THEN
						...
						ELSE
							 CALL CONTATESORERIAPRO(
								Entero_Cero,            Var_MonedaId,           Var_InstitucionID,  Var_CuentaBancaria,     Entero_Cero,
								Entero_Cero,            Entero_Cero,            Fecha_Valida,		Fecha_Valida,           Var_MontoMov,
								DescripcionCliente,     Var_ReferenciaMov,      CliClienteID,       EmitePoliza,            Entero_Cero,
